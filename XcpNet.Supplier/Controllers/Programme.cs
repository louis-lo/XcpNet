...
namespace XcpNet.Supplier.Controllers
{
    public class Programme : SupplierController
    {
        ...
        public void List(int type = -1, int categoryid = 0, int page = 0)
        {
            ...
            this["ProgrammeList"] = D.DistributorProgramme.GetListbyDistributor(DataSource, User.Identity.Id, Math.Max(0, categoryid), title, (D.DistributorProgramme.EProgrammeType)type, Distributor.Province, Distributor.City, Distributor.County, Math.Max(1, page), 10, 11);
            this["Type"] = type;
            this["KeyWord"] = title;
