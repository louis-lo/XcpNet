...
{
    public class CommShippingAddress : CommonControllers
    {
        public static string ClassName = "[type]ShippingAddress";
        ...
        {
            CheckMemberHelper(ClassName, "SetShippingAddress", "编辑收货地址")
        ...
        {
            CheckMemberHelper(ClassName, "AddShippingAddress", "添加收货地址")
                .AddArgument("Consignee", typeof(string), "收货人姓名")
                .AddArgument("Mobile", typeof(long), "联系手机号码")
                .AddArgument("PostId", typeof(int), "邮政编码")
                .AddArgument("Province", typeof(int), "省ID")
        ...
        {
            CheckMemberHelper(ClassName, "DelShippingAddress", "删除收货地址")
